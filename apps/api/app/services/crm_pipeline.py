...
from app.services.crm_mapping import (
...
async def run_crm_sync(
    ...
    *,
    ...
    # --------------------------------------------------------
    # Only qualified/cold leads enter active CRM flow
    # --------------------------------------------------------
    ...
    # --------------------------------------------------------
    # Check whether CRM sync already succeeded
    # --------------------------------------------------------
    ...
    try:
        ...
        # CRM failure must never lose the lead.
        return
